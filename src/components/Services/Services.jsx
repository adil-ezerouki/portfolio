        ...
        <section id='services' className='flex justify-center items-center flex-col gap-4'>
            ...
            <div className='flex justify-center gap-10 lg:flex-row flex-col'>
                <div className='lg:w-1/2 w-full flex-grow-0 bg-[#243439]  text-white p-6 rounded-2xl flex flex-col items-center text-center gap-4'>
                    ...
                    <span className='text-2xl'><span className='text-[#FF7F40] font-bold'>Shaping</span> Digital <br /> Dreams !</span>
                    ...
                    <button className='hover:scale-110 hover:transition-all  px-4 py-3 bg-[#FF7F40] text-white rounded-full'><a className='' href='#'>Hire Me</a></button>
                </div>
                <div className='lg:w-1/2 w-full flex-grow-0 bg-[#243439]  text-white p-6 rounded-2xl flex flex-col items-center text-center gap-4'>
                    ...
                    <span className='text-2xl'><span className='text-[#FF7F40] font-bold'>Transforming </span> Visions <br /> into Pixels !</span>
                ...
                <div className='lg:w-1/2 w-full flex-grow-0 bg-[#243439]  text-white p-6 rounded-2xl flex flex-col items-center text-center gap-4'>
                    ...
                    <span className='text-2xl'> <span className='text-[#FF7F40] font-bold'>Crafting </span> Scalable Infrastructures !</span>
